...
// Hàm tìm sinh viên theo GPA
void TimTheoGPA(SinhVien DanhSach[100], int TongSinhVien) {
    double GPA_tim;  // Khai báo GPA  muốn tìm
    bool exist;  // Khai báo biến exist để kiểm tra GPA có tồn tại hay không 

    cout<<"Nhap diem GPA muon tim: "; cin>>GPA_tim;
    ...
    // Nếu GPA không tồn tại
    if(!exist) {
        cout<<"KHONG ton tai diem GPA nay\n";
    }
}
...
// Hàm sắp xếp sinh viên theo GPA tăng dần
void GPAtang(SinhVien DanhSach[], int TongSinhVien)
{
    SinhVien temp;
    for (int i = 1; i <= TongSinhVien; i++)
    {
...
int main() {
    ...
    while (true) {
        ...
        switch (option) {
            ...
            case 6:
                cout << "\n++++++++++ TIM SINH VIEN THEO GPA ++++++++++" << endl;
                if (TongSinhVien > 0) {
                    TimTheoGPA(DanhSach,TongSinhVien);
                } else {
                    cout << "KHONG co sinh vien trong danh sach. Moi ban nhap lai";
                }
                break;
            case 7:
                cout <<"\n+++++++ SAP XEP SINH VIEN THEO GPA GIAM DAN +++++++" << endl;
                if (TongSinhVien > 0) {
                ...
                break;
            case 8:
                cout <<"\n+++++++ SAP XEP SINH VIEN THEO GPA TANG DAN +++++++" << endl;
                if (TongSinhVien > 0) {
